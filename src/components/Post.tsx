...
type propspost = { url: string, description: string, likes: number, username: string, time: string }

export default function Post({ url, description, likes, username, time }: propspost) {
